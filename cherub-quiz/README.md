...
#### Editing the Content
To edit the content in this project you need to edit the HTML in the index.html page. [Click on this link to go to the editor](https://github.com/medillcherubs/2017-web-week/cherub-quiz/edit/master/index.html). Make the changes you want to make, then click the green "Commit" button at the bottom of the page. You should see the changes appear within a minute on the WordPress site and on GitHub Pages.
...
<!-- Edit: https://github.com/medillcherubs/2017-web-week/cherub-quiz/edit/master/index.html -->
[/raw]
```
